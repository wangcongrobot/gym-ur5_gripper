...
class HDTArmEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, 
        ...
        mujoco_env.MujocoEnv.__init__(self, 'hdt_arm/pick_and_place.xml', frame_skip=5)
    ...
    def viewer_setup(self):
        body_id = self.sim.model.body_name2id('thumb_base')
    ...
    def _env_setup(self):
        ...
        # Move end effector into position.
        gripper_target = np.array([0, 0, 0] + self.sim.data.get_mocap_pos('thumb_base'))
